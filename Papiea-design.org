...
* Basic Interfaces
  :PROPERTIES:
  :CUSTOM_ID: h-Basic-Interfaces-10
  :END:
...
** Entity Reference
   :PROPERTIES:
   :CUSTOM_ID: h-Entity-Reference-910
   :END:
...
** Provider description
   :PROPERTIES:
   :CUSTOM_ID: h-Provider-description-295
   :END:
...
* Modules
  :PROPERTIES:
  :CUSTOM_ID: h-Modules-653
  :END:
** Databases
   :PROPERTIES:
   :CUSTOM_ID: h-Databases-582
   :END:
   #+BEGIN_note
...
** Dependent services
   :PROPERTIES:
   :CUSTOM_ID: h-Dependent-services-270
   :END:
*** Tasks
    :PROPERTIES:
    :CUSTOM_ID: h-Tasks-537
    :END:
...
*** Exporting APIs
    :PROPERTIES:
    :CUSTOM_ID: h-Exporting-APIs-478
    :END:
...
**** Provider facing APIs
     :PROPERTIES:
     :CUSTOM_ID: h-Provider-facing-APIs-135
     :END:
     Provider has two sets of APIs:
***** Provider's SDK    
      :PROPERTIES:
      :CUSTOM_ID: h-Provider's-SDK-318
      :END:
...
***** Provider to Papiea APIs
      :PROPERTIES:
      :CUSTOM_ID: h-Provider-to-Papiea-APIs-289
      :END:
...
**** User facing APIs
     :PROPERTIES:
     :CUSTOM_ID: h-User-facing-APIs-827
     :END:
...
*** Handling Potential Diffs    
    :PROPERTIES:
    :CUSTOM_ID: h-Handling-Potential-Diffs-232
    :END:
...
**** Change Spec Handler Pseudocode
     :PROPERTIES:
     :CUSTOM_ID: h-Change-Spec-Handler-Pseudocode-772
     :END:
     #+BEGIN_SRC typescript
...
*** SFS - Status Fields Signature
    :PROPERTIES:
    :CUSTOM_ID: h-SFS---Status-Fields-Signature-713
    :END:
...
**** Formal syntax of SFS
     :PROPERTIES:
     :CUSTOM_ID: h-Formal-syntax-of-SFS-552
     :END:
...
*** Intentful core
    :PROPERTIES:
    :CUSTOM_ID: h-Intentful-core-559
    :END:
...
**** Intentful Execution
     :PROPERTIES:
     :CUSTOM_ID: h-Intentful-Execution-807
     :END:
...
*** Procedures Signatures
    :PROPERTIES:
    :CUSTOM_ID: h-Procedures-Signatures-799
    :END:
...
**** Procedure Signature struct
     :PROPERTIES:
     :CUSTOM_ID: h-Procedure-Signature-struct-647
     :END:
...
*** Understanding Deltas
    :PROPERTIES:
    :CUSTOM_ID: h-Understanding-Deltas-85
    :END:
**** Matching SFSs to Deltas
     :PROPERTIES:
     :CUSTOM_ID: h-Matching-SFSs-to-Deltas-833
     :END:
**** Determining Order
     :PROPERTIES:
     :CUSTOM_ID: h-Determining-Order-204
     :END:
*** Provider
    :PROPERTIES:
    :CUSTOM_ID: h-Provider-545
    :END:
...
*** RBCA - test
    :PROPERTIES:
    :CUSTOM_ID: h-RBCA---test-415
    :END:
*** Scalability and Reliability
    :PROPERTIES:
    :CUSTOM_ID: h-Scalability-and-Reliability-438
    :END:
**** Leader election
     :PROPERTIES:
     :CUSTOM_ID: h-Leader-election-328
     :END:
**** Fault tolerance
     :PROPERTIES:
     :CUSTOM_ID: h-Fault-tolerance-995
     :END:
***** Dead Papiea Instance
      :PROPERTIES:
      :CUSTOM_ID: h-Dead-Papiea-Instance-997
      :END:
***** Dead Provider
      :PROPERTIES:
      :CUSTOM_ID: h-Dead-Provider-615
      :END:
*** Cleanup process
    :PROPERTIES:
    :CUSTOM_ID: h-Cleanup-process-996
    :END:
    - automatic deletion?
*** Auditing
    :PROPERTIES:
    :CUSTOM_ID: h-Auditing-539
    :END:
** Intentful Tasks                                          :Continue_Fixing:
   :PROPERTIES:
   :CUSTOM_ID: h-Intentful-Tasks-738
   :END:
...
** Provider Library
   :PROPERTIES:
   :CUSTOM_ID: h-Provider-Library-222
   :END:
*** Define Entity Model
    :PROPERTIES:
    :CUSTOM_ID: h-Define-Entity-Model-949
    :END:
**** YAML
     :PROPERTIES:
     :CUSTOM_ID: h-YAML-165
     :END:
**** CRUD
     :PROPERTIES:
     :CUSTOM_ID: h-CRUD-951
     :END:
*** Initialize
    :PROPERTIES:
    :CUSTOM_ID: h-Initialize-776
    :END:
*** Callback Mechanism
    :PROPERTIES:
    :CUSTOM_ID: h-Callback-Mechanism-840
    :END:
*** Running Effect Validator
    :PROPERTIES:
    :CUSTOM_ID: h-Running-Effect-Validator-388
    :END:
*** Status Changes Handlers
    :PROPERTIES:
    :CUSTOM_ID: h-Status-Changes-Handlers-59
    :END:
**** Registring
     :PROPERTIES:
     :CUSTOM_ID: h-Registring-714
     :END:
**** Running using context
     :PROPERTIES:
     :CUSTOM_ID: h-Running-using-context-952
     :END:
*** Procedures
    :PROPERTIES:
    :CUSTOM_ID: h-Procedures-51
    :END:
**** Registring
     :PROPERTIES:
     :CUSTOM_ID: h-Registring-14
     :END:
**** Running using context
     :PROPERTIES:
     :CUSTOM_ID: h-Running-using-context-248
     :END:
*** Example Provider
    :PROPERTIES:
    :CUSTOM_ID: h-Example-Provider-851
    :END:

* Full files
  :PROPERTIES:
  :CUSTOM_ID: h-Full-files-380
  :END:
** Core definitions
   :PROPERTIES:
   :CUSTOM_ID: h-Core-definitions-982
   :END:
*** /src/core.ts
    :PROPERTIES:
    :CUSTOM_ID: h-/src/corets-142
    :END:
...
** Databases
   :PROPERTIES:
   :CUSTOM_ID: h-Databases-581
   :END:
*** /src/databases/spec_db_interface.ts
    :PROPERTIES:
    :CUSTOM_ID: h-/src/databases/spec_db_interfacets-710
    :END:
...
*** /src/databases/status_db_interface.ts
    :PROPERTIES:
    :CUSTOM_ID: h-/src/databases/status_db_interfacets-717
    :END:
...
*** /src/databases/providers_db_interface.ts
    :PROPERTIES:
    :CUSTOM_ID: h-/src/databases/providers_db_interfacets-873
    :END:
...
** Differ   
   :PROPERTIES:
   :CUSTOM_ID: h-Differ-154
   :END:
*** /src/intentful_core/differ_interface.ts
    :PROPERTIES:
    :CUSTOM_ID: h-/src/intentful_core/differ_interfacets-270
    :END:
...
** Tasks
   :PROPERTIES:
   :CUSTOM_ID: h-Tasks-246
   :END:
*** /src/tasks/task_manager_interface.ts
    :PROPERTIES:
    :CUSTOM_ID: h-/src/tasks/task_manager_interfacets-560
    :END:
...
** Provider SDK
   :PROPERTIES:
   :CUSTOM_ID: h-Provider-SDK-953
   :END:
*** Typescript: /src/provider_sdk/typescript_sdk_interface
    :PROPERTIES:
    :CUSTOM_ID: h-Typescript:-/src/provider_sdk/typescript_sdk_interface-970
    :END:
...
** /src-go/papiea/engine/core.go
   :PROPERTIES:
   :CUSTOM_ID: h-/src-go/papiea/engine/corego-476
   :END:
...
** /src-go/papiea/engine/server.go
   :PROPERTIES:
   :CUSTOM_ID: h-/src-go/papiea/engine/servergo-377
   :END:
...
** /src-go/papiea/engine/provider.go 
   :PROPERTIES:
   :CUSTOM_ID: h-/src-go/papiea/engine/providergo-964
   :END:
...
** /src-go/papiea/engine/tasks.go
   :PROPERTIES:
   :CUSTOM_ID: h-/src-go/papiea/engine/tasksgo-352
   :END:
