...
*** Provider
    ...
    #+BEGIN_SRC go
      func (api_ctx papiea_api_ctx) register_intentful_callback(sfs sfs_signature, callback_url string) err {

      }

      func (api_ctx papiea_api_ctx) register_procedural_callback(sfs sfs_signature, callback_url string) err {
