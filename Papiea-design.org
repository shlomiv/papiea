...
* Formalities
  ...
  2. Let $S=$ be the set of all $T$. This is essentially the space of all states our world could be
     in.
  3. Let $cs \in S$ be a represention of "what it is we *actually have*"
  4. Let $ds \in S$ be a represention of "what it is we *desire to have*"
  ...
  iterate through this ordered list one item at a time, see if $dispatch_{fn_i} \in diff$. If it is,
  ${fn_i}$ is applied, $cs$ and $diff$ are recalculated, and we run thrugh $dlist$ again.
