...
var G__9380 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__9380,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__9380;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq9382){
var G__9383 = cljs.core.first.call(null,seq9382);
var seq9382__$1 = cljs.core.next.call(null,seq9382);
var G__9384 = cljs.core.first.call(null,seq9382__$1);
var seq9382__$2 = cljs.core.next.call(null,seq9382__$1);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9383,G__9384,seq9382__$2);
});
...
var file = cljs.core.get.call(null,map__9389__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__9389__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__9389__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__9389,map__9389__$1,file,line,column){
return (function (p1__9388_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__9388_SHARP_));
});})(map__9389,map__9389__$1,file,line,column))
...
var temp__5457__auto___9391 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___9391)){
var message_9392 = temp__5457__auto___9391;
cljs.core.println.call(null,message_9392);
} else {
}
...
var temp__5457__auto___9393 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___9393)){
var message_9394 = temp__5457__auto___9393;
cljs.core.println.call(null,message_9394);
} else {
}
...
var output_dir__$1 = (function (){var G__9395 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9395),"/"].join('');
} else {
return G__9395;
}
})();
...
var G__9397 = exception.stack;
var G__9397__$1 = (((G__9397 == null))?null:clojure.string.split_lines.call(null,G__9397));
var G__9397__$2 = (((G__9397__$1 == null))?null:cljs.core.get.call(null,G__9397__$1,depth));
if((G__9397__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__9397__$2);
}
} else {
...
var vec__9398 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__9398,(0),null);
var column = cljs.core.nth.call(null,vec__9398,(1),null);
var vec__9401 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__9401,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__9401,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__9401,(2),null);
...
var m__$1 = (function (){var G__9404 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__9408 = (function (){var G__9407 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__9407);
} else {
return G__9407;
}
})();
...
return cljs.core.vary_meta.call(null,G__9409,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__9413 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__9413,(0),null);
var types = vec__9413;
...
return cljs.core.map.call(null,(function (p__9416){
var vec__9417 = p__9416;
var ns = cljs.core.nth.call(null,vec__9417,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__9417,(1),null);
return ((function (vec__9417,ns,vars__$1){
return (function (){
...
var G__9420 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__9420,G__9420__$1,env,once_fixtures,each_fixtures,vec__9417,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__9420,G__9420__$1,env,once_fixtures,each_fixtures,vec__9417,ns,vars__$1){
return (function (){
...
var temp__5457__auto___9426 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___9426)){
var t_9427 = temp__5457__auto___9426;
each_fixture_fn.call(null,((function (seq__9421,chunk__9422,count__9423,i__9424,t_9427,temp__5457__auto___9426,v,each_fixture_fn,G__9420,G__9420__$1,env,once_fixtures,each_fixtures,vec__9417,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9427)));
});})(seq__9421,chunk__9422,count__9423,i__9424,t_9427,temp__5457__auto___9426,v,each_fixture_fn,G__9420,G__9420__$1,env,once_fixtures,each_fixtures,vec__9417,ns,vars__$1))
);
} else {
}


var G__9428 = seq__9421;
var G__9429 = chunk__9422;
var G__9430 = count__9423;
var G__9431 = (i__9424 + (1));
seq__9421 = G__9428;
chunk__9422 = G__9429;
count__9423 = G__9430;
i__9424 = G__9431;
...
var temp__5457__auto__ = cljs.core.seq.call(null,seq__9421);
if(temp__5457__auto__){
var seq__9421__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__9421__$1)){
var c__4461__auto__ = cljs.core.chunk_first.call(null,seq__9421__$1);
var G__9432 = cljs.core.chunk_rest.call(null,seq__9421__$1);
var G__9433 = c__4461__auto__;
var G__9434 = cljs.core.count.call(null,c__4461__auto__);
var G__9435 = (0);
seq__9421 = G__9432;
chunk__9422 = G__9433;
count__9423 = G__9434;
...
var temp__5457__auto___9436__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___9436__$1)){
var t_9437 = temp__5457__auto___9436__$1;
each_fixture_fn.call(null,((function (seq__9421,chunk__9422,count__9423,i__9424,t_9437,temp__5457__auto___9436__$1,v,seq__9421__$1,temp__5457__auto__,each_fixture_fn,G__9420,G__9420__$1,env,once_fixtures,each_fixtures,vec__9417,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9437)));
});})(seq__9421,chunk__9422,count__9423,i__9424,t_9437,temp__5457__auto___9436__$1,v,seq__9421__$1,temp__5457__auto__,each_fixture_fn,G__9420,G__9420__$1,env,once_fixtures,each_fixtures,vec__9417,ns,vars__$1))
);
} else {
}


var G__9438 = cljs.core.next.call(null,seq__9421__$1);
var G__9439 = null;
var G__9440 = (0);
var G__9441 = (0);
seq__9421 = G__9438;
...
});})(each_fixture_fn,G__9420,G__9420__$1,env,once_fixtures,each_fixtures,vec__9417,ns,vars__$1))
);
});})(each_fixture_fn,G__9420,G__9420__$1,env,once_fixtures,each_fixtures,vec__9417,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9420__$1)].join('')));

}
})());
});
;})(vec__9417,ns,vars__$1))
