...
export interface Spec_DB {
    ...
    update_spec(entity_metadata: core.Metadata, spec:core.Spec): Promise<[core.Metadata | null, core.Spec | null]>;

    // Get the spec of a particular entity from the db. Returns both
    // current metadata and the spec of that entity.
    get_spec(entity_ref: core.Entity_Reference): Promise<[core.Metadata | null, core.Spec | null]>;
    ...
    // dsl.
    list_specs(fields_map: any): Promise<[core.Metadata | null, core.Spec | null][]>;
}
